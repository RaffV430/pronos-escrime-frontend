export default function ScoringRules({ type = 'pools' }) {
  ...
  return <details className="scoring-rules">
    ...
    {pools ? <>
      ...
      <p><strong>Score exact :</strong> 4 points si les deux scores sont corrects.</p>
      <p><strong>Bon vainqueur, autre score :</strong> 1 point.</p>
      <p><strong>Mauvais vainqueur ou égalité pronostiquée :</strong> 0 point.</p>
      <p className="muted">Les paliers ne se cumulent pas. Ce barème concerne les matchs, pas les pronostics de podium.</p>
    </>}
  </details>;
}
