export default function MatchTiming({ match, now }) {
 ...
 <small>{match.isFinished?'Résultat définitif':'Données provisoires'} · Dernière vérification officielle : {date(match.sourceCheckedAt)}</small></div>;
}
